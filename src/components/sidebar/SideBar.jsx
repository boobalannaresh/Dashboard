      ...
      <ul className="sidebar-nav" id="sidebar-nav">
        ...
        <li className="nav-item">
          ...
          >
            ...
            <li>
              <Link to="/portal/itemmaster" style={{ textDecoration: "none" }}>
            ...
            <li>
              <Link to="/portal/itemrequest" style={{ textDecoration: "none" }}>
              <i class="bi bi-send-check-fill" style={{fontSize:"20px"}}></i>
                <span>Item Request</span>
              </Link>
            </li>
            <li>
              <Link to="/portal/visiting" style={{ textDecoration: "none" }}>
              <i class="bi bi-clipboard-check-fill" style={{fontSize:"20px"}}></i>
                <span>Visiting</span>
              </Link>
            </li>
            <li>
        ...
        <li className="nav-item">
          ...
          >
            ...
            <li>
              <Link to="receiptreport" style={{ textDecoration: "none" }}>
            ...
            <li>
              <Link to="DSRdayreport" style={{ textDecoration: "none" }}>
            ...
            <li>
              <Link to="invoicehistory" style={{ textDecoration: "none" }}>
            ...
            <li>
              <Link to="mechanicsalesreport" style={{ textDecoration: "none" }}>
